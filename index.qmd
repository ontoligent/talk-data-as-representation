...
We can study the  `Patient-Doctor` relationship locally

- As it is **reintermediated** by the data
- Once doctors catch on ...

Or we can study the emergent effects of this on medicine itself

- Will we have hospitals?
- Where and how will medical decisions be made?
- What does the Ubering of medicine mean for healthcare as a system?
